 ...
 * @author Bruno Salmon
 */
public final class RayTracerApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setScene(new Scene(new TracerView((int) w, (int) h, new RayTracerPixelComputer()).buildView(), w, h, Color.BLACK));
        primaryStage.setTitle("WebFX Ray tracer");
        primaryStage.show();
    }
}