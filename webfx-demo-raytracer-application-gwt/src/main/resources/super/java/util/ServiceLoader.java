...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.platform.client.services.webassembly.spi.WebAssemblyProvider": return new ServiceLoader<S>();
            ...
            case "dev.webfx.platform.shared.services.webworker.spi.WorkerServiceProvider": return new ServiceLoader<S>(dev.webfx.platform.gwt.services.webworker.spi.impl.GwtWorkerServiceProvider::new);
